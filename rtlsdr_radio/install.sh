...
echo ""
echo "=========================================="
echo "!!! RESTART REQUIRED BEFORE USE !!!"
echo "=========================================="
echo ""
echo "IMPORTANT: You MUST restart Volumio before enabling this plugin:"
echo "  sudo systemctl restart volumio"
echo ""
echo "DO NOT enable the plugin until after restart!"
echo "Enabling without restart will cause errors."
echo ""
echo "=========================================="
echo ""
